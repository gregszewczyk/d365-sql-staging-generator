...
export const GroupPanel: React.FC<GroupPanelProps> = (props) => {
  ...
  const logicToggle = (
    <div className="ossfb-logic-toggle" role="radiogroup" aria-label="Group logic">
      <button
        type="button"
        role="radio"
        aria-checked={group.logic === "and"}
        className={`ossfb-logic-btn ${group.logic === "and" ? "ossfb-logic-active" : ""}`}
        disabled={disabled}
      ...
      <button
        ...
        className={`ossfb-logic-btn ${group.logic === "or" ? "ossfb-logic-active" : ""}`}
        disabled={disabled}
  ...
  return (
    <div className={isRoot ? "ossfb-group ossfb-group-root" : "ossfb-group ossfb-group-nested"}>
      <div className="ossfb-group-header">
        {logicToggle}
        {!isRoot && (
          <button
            type="button"
      ...
      <div className="ossfb-group-actions">
        <button
          type="button"
          className="ossfb-link-btn"
          disabled={disabled}
